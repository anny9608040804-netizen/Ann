...
SVG_ICONS = {
    'bull': '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
        <defs>
            ...
            <filter id="bull-glow" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur in="SourceGraphic" stdDeviation="2" result="blur" />
                <feColorMatrix in="blur" type="matrix" values="0 0 0 0 0.29 0 0 0 0 0.87 0 0 0 0 0.5 0 0 0 0.5 0" result="glow" />
                <feMerge><feMergeNode in="glow" /><feMergeNode in="SourceGraphic" /></feMerge>
            </filter>
        </defs>
        <g filter="url(#bull-glow)">
            <path d="M23 6L13.5 15.5L8.5 10.5L1 18" stroke="url(#bull-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M17 6H23V12" stroke="url(#bull-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
    </svg>''',
    'bear': '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
        <defs>
            <linearGradient id="bear-grad" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style="stop-color:#f87171;stop-opacity:1" />
                <stop offset="100%" style="stop-color:#ef4444;stop-opacity:1" />
            </linearGradient>
            <filter id="bear-glow" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur in="SourceGraphic" stdDeviation="2" result="blur" />
                <feColorMatrix in="blur" type="matrix" values="0 0 0 0 0.97 0 0 0 0 0.44 0 0 0 0 0.44 0 0 0 0.5 0" result="glow" />
                <feMerge><feMergeNode in="glow" /><feMergeNode in="SourceGraphic" /></feMerge>
            </filter>
        </defs>
        <g filter="url(#bear-glow)">
            <path d="M23 18L13.5 8.5L8.5 13.5L1 6" stroke="url(#bear-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M17 18H23V12" stroke="url(#bear-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
    </svg>''',
    'alert': '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
        <defs>
            ...
            <filter id="alert-glow" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur in="SourceGraphic" stdDeviation="2" result="blur" />
                <feColorMatrix in="blur" type="matrix" values="0 0 0 0 0.98 0 0 0 0 0.8 0 0 0 0 0.08 0 0 0 0.5 0" result="glow" />
                <feMerge><feMergeNode in="glow" /><feMergeNode in="SourceGraphic" /></feMerge>
            </filter>
        </defs>
        <g filter="url(#alert-glow)">
            <path d="M10.29 3.86L1.82 18C1.64551 18.3024 1.55296 18.6453 1.55199 18.9945C1.55103 19.3437 1.64169 19.6871 1.81497 19.9905C1.98824 20.2939 2.23814 20.5467 2.53994 20.7239C2.84175 20.9012 3.18514 20.9968 3.535 21H20.465C20.8149 20.9968 21.1583 20.9012 21.4601 20.7239C21.7619 20.5467 22.0118 20.2939 22.185 19.9905C22.3583 19.6871 22.449 19.3437 22.448 18.9945C22.447 18.6453 22.3545 18.3024 22.18 18L13.71 3.86C13.5317 3.56613 13.2807 3.32314 12.9812 3.15449C12.6817 2.98585 12.3437 2.89722 12 2.89722C11.6563 2.89722 11.3183 2.98585 11.0188 3.15449C10.7193 3.32314 10.4683 3.56613 10.29 3.86Z" stroke="url(#alert-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M12 9V13" stroke="url(#alert-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M12 17H12.01" stroke="url(#alert-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
    </svg>''',
    'lock': '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
        <defs>
            ...
            <filter id="lock-glow" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur in="SourceGraphic" stdDeviation="2" result="blur" />
                <feColorMatrix in="blur" type="matrix" values="0 0 0 0 0.75 0 0 0 0 0.52 0 0 0 0 0.99 0 0 0 0.5 0" result="glow" />
                <feMerge><feMergeNode in="glow" /><feMergeNode in="SourceGraphic" /></feMerge>
            </filter>
        </defs>
        <g filter="url(#lock-glow)">
            <rect x="3" y="11" width="18" height="11" rx="2" ry="2" stroke="url(#lock-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M7 11V7C7 5.67392 7.52678 4.40215 8.46447 3.46447C9.40215 2.52678 10.6739 2 12 2C13.3261 2 14.5979 2.52678 15.5355 3.46447C16.4732 4.40215 17 5.67392 17 7V11" stroke="url(#lock-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M12 15V17" stroke="url(#lock-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
    </svg>''',
    'unlock': '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
        <defs>
            <linearGradient id="unlock-grad" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style="stop-color:#f472b6;stop-opacity:1" />
                <stop offset="100%" style="stop-color:#ec4899;stop-opacity:1" />
            </linearGradient>
            <filter id="unlock-glow" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur in="SourceGraphic" stdDeviation="2" result="blur" />
                <feColorMatrix in="blur" type="matrix" values="0 0 0 0 0.96 0 0 0 0 0.45 0 0 0 0 0.71 0 0 0 0.5 0" result="glow" />
                <feMerge><feMergeNode in="glow" /><feMergeNode in="SourceGraphic" /></feMerge>
            </filter>
        </defs>
        <g filter="url(#unlock-glow)">
            <rect x="3" y="11" width="18" height="11" rx="2" ry="2" stroke="url(#unlock-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M7 11V7C7 5.67392 7.52678 4.40215 8.46447 3.46447C9.40215 2.52678 10.6739 2 12 2C13.3261 2 14.5979 2.52678 15.5355 3.46447C16.4732 4.40215 17 5.67392 17 7V8" stroke="url(#unlock-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M12 15V17" stroke="url(#unlock-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
    </svg>''',
    'tech': '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
        <defs>
            ...
            <filter id="tech-glow" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur in="SourceGraphic" stdDeviation="2" result="blur" />
                <feColorMatrix in="blur" type="matrix" values="0 0 0 0 0.38 0 0 0 0 0.65 0 0 0 0 0.98 0 0 0 0.5 0" result="glow" />
                <feMerge><feMergeNode in="glow" /><feMergeNode in="SourceGraphic" /></feMerge>
            </filter>
        </defs>
        <g filter="url(#tech-glow)">
            <rect x="4" y="4" width="16" height="16" rx="2" stroke="url(#tech-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M9 9H15" stroke="url(#tech-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M9 15H15" stroke="url(#tech-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M12 12V12.01" stroke="url(#tech-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M12 4V2" stroke="url(#tech-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M20 12H22" stroke="url(#tech-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M12 20V22" stroke="url(#tech-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M4 12H2" stroke="url(#tech-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
    </svg>''',
    'swap': '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
        <defs>
            ...
            <filter id="swap-glow" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur in="SourceGraphic" stdDeviation="2" result="blur" />
                <feColorMatrix in="blur" type="matrix" values="0 0 0 0 0.5 0 0 0 0 0.55 0 0 0 0 0.97 0 0 0 0.5 0" result="glow" />
                <feMerge><feMergeNode in="glow" /><feMergeNode in="SourceGraphic" /></feMerge>
            </filter>
        </defs>
        <g filter="url(#swap-glow)">
            <path d="M20 17H4M4 17L8 13M4 17L8 21" stroke="url(#swap-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M4 7H20M20 7L16 3M20 7L16 11" stroke="url(#swap-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
    </svg>''',
    'news': '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
        <defs>
            <linearGradient id="news-grad" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style="stop-color:#fb923c;stop-opacity:1" />
                <stop offset="100%" style="stop-color:#f97316;stop-opacity:1" />
            </linearGradient>
            <filter id="news-glow" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur in="SourceGraphic" stdDeviation="2" result="blur" />
                <feColorMatrix in="blur" type="matrix" values="0 0 0 0 0.98 0 0 0 0 0.57 0 0 0 0 0.24 0 0 0 0.5 0" result="glow" />
                <feMerge><feMergeNode in="glow" /><feMergeNode in="SourceGraphic" /></feMerge>
            </filter>
        </defs>
        <g filter="url(#news-glow)">
            <path d="M12 14C13.6569 14 15 12.6569 15 11C15 9.34315 13.6569 8 12 8C10.3431 8 9 9.34315 9 11C9 12.6569 10.3431 14 12 14Z" stroke="url(#news-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M12 2C14.3869 2 16.6761 2.94821 18.364 4.63604C20.0518 6.32387 21 8.61305 21 11V22H3V11C3 8.61305 3.94821 6.32387 5.63604 4.63604C7.32387 2.94821 9.61305 2 12 2Z" stroke="url(#news-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M12 18V18.01" stroke="url(#news-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
    </svg>''',
    'fund': '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
        <defs>
            <linearGradient id="fund-grad" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style="stop-color:#34d399;stop-opacity:1" />
                <stop offset="100%" style="stop-color:#10b981;stop-opacity:1" />
            </linearGradient>
            <filter id="fund-glow" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur in="SourceGraphic" stdDeviation="2" result="blur" />
                <feColorMatrix in="blur" type="matrix" values="0 0 0 0 0.2 0 0 0 0 0.83 0 0 0 0 0.6 0 0 0 0.5 0" result="glow" />
                <feMerge><feMergeNode in="glow" /><feMergeNode in="SourceGraphic" /></feMerge>
            </filter>
        </defs>
        <g filter="url(#fund-glow)">
            <path d="M12 2V22" stroke="url(#fund-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M17 5H9.5C8.57174 5 7.6815 5.36875 7.02513 6.02513C6.36875 6.6815 6 7.57174 6 8.5C6 9.42826 6.36875 10.3185 7.02513 10.9749C7.6815 11.6313 8.57174 12 9.5 12H14.5C15.4283 12 16.3185 12.3687 16.9749 13.0251C17.6313 13.6815 18 14.5717 18 15.5C18 16.4283 17.6313 17.3185 16.9749 17.9749C16.3185 18.6313 15.4283 19 14.5 19H6" stroke="url(#fund-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
    </svg>''',
    'event': '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
        <defs>
            <linearGradient id="event-grad" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style="stop-color:#fde047;stop-opacity:1" />
                <stop offset="100%" style="stop-color:#eab308;stop-opacity:1" />
            </linearGradient>
            <filter id="event-glow" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur in="SourceGraphic" stdDeviation="2" result="blur" />
                <feColorMatrix in="blur" type="matrix" values="0 0 0 0 0.99 0 0 0 0 0.88 0 0 0 0 0.28 0 0 0 0.5 0" result="glow" />
                <feMerge><feMergeNode in="glow" /><feMergeNode in="SourceGraphic" /></feMerge>
            </filter>
        </defs>
        <g filter="url(#event-glow)">
            <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" stroke="url(#event-grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
    </svg>''',
}
...
def generate_html_preview():
    ...
    <head>
        ...
        <style>
            ...
            /* 新增 SVG 的 CSS 樣式，使其在霓虹背景上更好看 */
            svg {{ width: 100%; height: 100%; filter: drop-shadow(0 0 5px rgba(255,255,255,0.3)); }}
        </style>
    </head>
